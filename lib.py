...
class AddressBook(UserDict):
    ...
    def get_upcoming_birthdays(self, contacts, days=7):
        upcoming_birthdays = []
        today = date.today()

        for contact in contacts.data:
            record = contacts.find(contact)
        ...
        # Відповідно до п. 6 критеріїв оцінювання: " Всі дані повинні виводитися у зрозумілому та зручному для користувача форматі."
        # тож питання в тому, чи не буде зайвим ще перетворювати список словників у більш зрозумілий формат
        # [{'name': 'Ivan', 'congratulation_date': '16.10.2024'}]
